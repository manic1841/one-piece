...
export function createIncomeStatementItem(
...
export function createIncomeStatementData(
  overrides?: Partial<IncomeStatementData>,
): IncomeStatementData {
  return {
    revenue: {
      total: 0,
...
export function createIncomeStatementItems(
  count: number,
  overrides?: Partial<IncomeStatementItem>,
): IncomeStatementItem[] {
...
export function createBalanceSheetItems(
  count: number,
...
export function createCashFlowItems(
  count: number,
