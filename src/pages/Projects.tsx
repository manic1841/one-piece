...
const Projects: React.FC = () => {
    ...
    const { projects, loading, selectedProject, setSelectedProject, getProjectTransactions } =
        ...
        <div className="space-y-6">
            ...
            {projects.length > 0 && (
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <p className="text-sm text-gray-500 mt-2">Across {projects.length} project{projects.length !== 1 ? 's' : ''}</p>
                </div>
            )}
