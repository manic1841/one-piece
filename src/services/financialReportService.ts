...
class FinancialReportService {
    ...
    async generateFinancialReports(
        ...
        const [
            ...
            plannedIncomeService.getPlannedIncomesForPeriod(householdId, startDate, endDate),
            transactionService.getTransactionsByPeriod(householdId, startDate, endDate),
        ...
        const accountSnapshots = await this.getAccountSnapshots(householdId, accounts.map(a => a.id), year, month);
        ...
        const prevAccountSnapshots = await this.getAccountSnapshots(householdId, accounts.map(a => a.id), prevYear, prevMonth);
