...
export const PlannedIncomeCategorySchema = z.enum(['salary', 'bonus', 'other']);
export type PlannedIncomeCategory = z.infer<typeof PlannedIncomeCategorySchema>;
...
export const PlannedIncomeSchema = z.object({
    ...
    amount: z.number(),
    category: PlannedIncomeCategorySchema,
