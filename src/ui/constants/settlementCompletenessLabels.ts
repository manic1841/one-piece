 ...
 * are excluded; they get their own DEBT_PAYMENT check (ADR-0048).
 * Target-type names delegate to the watch list label map rather than a second
 * copy (ui-labeling-guideline: extend the existing map, do not duplicate it).
 */
