...
export const TransactionItem: React.FC<TransactionItemProps> = ({
  ...
  const investmentEntry = transaction.entries.find((e: JournalEntryLine) =>
    e.ledgerCode.startsWith(LEDGER_CODES.ASSET_INVESTMENT),
  );
  const equityEntry = transaction.entries.find((e: JournalEntryLine) =>
    e.ledgerCode.startsWith(LEDGER_PREFIX.EQUITY),
  );
  const primaryEntry =
    investmentEntry ||
    equityEntry ||
